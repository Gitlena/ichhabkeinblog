...
def upgrade(migrate_engine):
    ...
    def test_make_update_script_for_model(self):
        """Construct script source from differences of two models.py"""
    ...
    def test_make_update_script_for_equal_models(self):
        """Try to make update script from two identical models.py"""
...
class TestSqlScript(fixture.Pathed, fixture.DB):
    ...
    def test_success(self):
        ...
        contents = 'from migrate.tests.fixture.models.py import tmp_sql_table\n' + contents
        f = open(script_path, 'w')
        f.write(contents)
        f.close()
