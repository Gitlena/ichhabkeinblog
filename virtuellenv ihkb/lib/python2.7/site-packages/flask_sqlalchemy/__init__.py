...
models_committed = _signals.signal('models.py-committed')
before_models_committed = _signals.signal('before-models.py-committed')
...
class BaseQuery(orm.Query):
    """The default query object used for models.py, and exposed as
    :attr:`~SQLAlchemy.Query`. This can be subclassed and
    replaced for individual models.py by setting the :attr:`~Model.query_class`
...
class Model(object):
    """Baseclass for custom user models.py."""
